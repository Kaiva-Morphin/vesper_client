...
<div class=" vh flex-grow flex">
    ...
    <Scrollable 
    class="w-[128px]"
    style="flex-basis:{$calls_val}px"
    viewport_class="flex-grow max-vh"
    content_class="card-100 card-base card-100-border flex flex-col gap-2 p-2 {$calls_val == 0 ? 'hidden' : ''}"
    >
            <Channel></Channel>
            <Channel></Channel>
            <Channel></Channel>
    ...
    <div class="wrapper w-[128px]" style="flex-basis:{$calls_val}px">
      <div bind:this={viewport} class="viewport max-vh">
        <div bind:this={contents} class="card-100 card-base card-100-border flex flex-col gap-2 p-2 {$calls_val == 0 ? 'hidden' : ''}">
            <Channel></Channel>
            <Channel></Channel>
            <Channel></Channel>
            <Channel></Channel>
