...
<div class="w-full flex relative justify-center bg-inherit">
    <div class="absolute w-full left_separator self-center"></div>
    <div class="z-10 bg-inherit px-2 w-fit pb-1"><slot/></div>
</div>
